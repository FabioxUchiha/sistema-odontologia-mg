   ...
   <div class="content">
       ...
       <div class="box box-primary">
           <div class="box-body" style="background-image: url(https://mdbootstrap.com/img/Photos/Others/background5.jpg);">
               <div class="row">
                   <?php echo Form::model($inventario, ['route' => ['inventarios.update', $inventario->id], 'method' => 'patch']); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sistema-odontologia-mg\resources\views/inventarios/edit.blade.php ENDPATH**/ ?>