                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class='btn-group'>
                            ...
                            <a href="<?php echo e(route('roles.show', [$role->id])); ?>" class='btn btn-default btn-xs'>
                                <i class="glyphicon glyphicon-eye-open"></i></a>
                            <?php endif; ?>
                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('editar roles')): ?>
                            <a href="<?php echo e(route('roles.edit', [$role->id])); ?>" class='btn btn-default btn-xs'>
...
<?php /**PATH C:\laragon\www\sistema-odontologia-mg\resources\views/roles/table.blade.php ENDPATH**/ ?>